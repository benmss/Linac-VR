...
public class NormalSolver
{
    ...
    /// </param>
    /* public void RecalculateNormals(List<MarchingMeshCreator.MeshData> meshes) {
      for (int i = 0; i < meshes.Count; i++) {        
        meshes[i].normals = RecalculateNormals(meshes[i].verts, meshes[i].indices, 91);        
      }
    }
    
    public Vector3[] RecalculateNormals(List<Vector3> vertices, List<int> triangles, float angle) {
        ...
        var triNormals = new Vector3[triangles.Count / 3];
